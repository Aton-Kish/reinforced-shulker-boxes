...
public class DispenserBehaviorTests {
    private static final String TEST_ENVIRONMENT_DEFAULT = String.format("%s:dispenser_behavior/default",
    ...
    public static final Collection<TestFunction> TEST_FUNCTIONS = new ArrayList<>() {
        {
            ...
            for (Block block : ModBlocks.REINFORCED_SHULKER_BOX_MAP
                ...
                add(DispenserBehaviorTests.createTest(
                        String.format("Dispense %s", block.getName().getString()),
                        block));
            }
